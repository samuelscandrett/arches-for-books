"""
Django settings for arches_for_books project.
"""
...
DATATYPE_LOCATIONS.append('arches_for_books.datatypes')
FUNCTION_LOCATIONS.append('arches_for_books.functions')
ETL_MODULE_LOCATIONS.append('arches_for_books.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('arches_for_books.search_components')
...
SECRET_KEY = 'django-insecure-0sm(&il5h)07v@jn(l#ngdne@)_p7r+nfy&_q9&#divv2tp=l4'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches_for_books.urls"
ROOT_HOSTCONF = "arches_for_books.hosts"

DEFAULT_HOST = "arches_for_books"
...
ELASTICSEARCH_PREFIX = 'arches_for_books'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_for_books.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches_for_books",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = 'arches_for_books.wsgi.application'
...
SESSION_COOKIE_NAME = 'arches_for_books'
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches_for_books.search.es_mapping_modifier.EsMappingModifier"]
